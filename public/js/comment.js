...
function () {
  ...
  _createClass(Comment, [{
    ...
    value: function save() {
      ...
      var entity = $("meta[name='entity-uuid']").attr('content');
      var parent = $("meta[name='parent-id']").attr('content');
      var id = $("meta[name='comment-id']").attr('content');
      var content = $(".uc-comments #uc-content").val();
    ...
    key: "toggleReplyButtonsListener",
    value: function toggleReplyButtonsListener() {
      $('.uc-comments .uc-toggle-reply').on('click', function (event) {
        var replyId = $(event.currentTarget).data('commentId');
...
module.exports = __webpack_require__(/*! /home/dimitri/www/uccello/territory-package/packages/uccello/comment/resources/js/comment.js */"./resources/js/comment.js");
